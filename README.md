...
This repo can ship as static files plus `api/expenses.js`, `api/status.js`, `api/voice.js`, and `api/ocr.js`.

1. Import the GitHub repo in Vercel.
2. Set `NOTION_TOKEN` and `NOTION_EXPENSES_DATA_SOURCE_ID` in the project env. Optionally set `SARVAM_API_KEY` and `GOOGLE_CLOUD_VISION_API_KEY`.
