...
const COPY = {
  en: {
    ...
    notionAccountsHint: 'Opening balance minus expenses tagged with that Account. Credit can be negative (amount owed).',
  ...
  hi: {
    ...
    notionAccountsHint: 'शुरुआती शेष में से उस खाते पर टैग खर्च घटाया गया। क्रेडिट ऋणात्मक हो सकता है (बाकी रकम)।',
