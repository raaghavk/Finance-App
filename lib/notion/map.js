...
(function (root, factory) {
  ...
  var ACCOUNT_COLORS = {
    Cash: '#C45C26',
    UPI: '#3B82F6',
    'Primary debit': '#1D4ED8',
    'Primary credit': '#7C3AED',
    Corporate: '#0F766E',
  };
   ...
   * Null opening is treated as 0 for the sum; openingMissing flags the gap.
   */
  function buildAccountBalances(accounts, expenses) {
    var spend = spendByAccount(expenses);
    var known = {};
    var rows = (accounts || []).map(function (acct) {
      var opening = acct.openingBalance;
      var openingMissing = opening === null || opening === undefined;
      ...
      return {
        ...
        name: acct.name,
        notes: acct.notes || '',
        openingBalance: openingMissing ? null : opening,
        openingMissing: openingMissing,
        spent: spent,
        expenseCount: spend.count[acct.name] || 0,
        balance: (openingMissing ? 0 : opening) - spent,
      };
    });
    Object.keys(spend.spent).forEach(function (name) {
      ...
      rows.push({
        ...
        openingBalance: null,
        openingMissing: true,
        spent: spend.spent[name],
        expenseCount: spend.count[name] || 0,
        balance: 0 - spend.spent[name],
      });
    });
    return rows;
  }
  ...
  var SAMPLE_NOTION_EXPENSES = [
    ...
    { Name: 'The Hazelnut Factory', Amount: 670, date: '2026-09-07', Category: 'Food', Kind: 'Travel', Trip: 'Varanasi Sep 2026', Payment: 'Other', Account: 'UPI', Status: 'Logged', Reimbursable: false },
    { Name: 'ITH Varanasi dorm', Amount: 1139, date: '2026-09-06', Category: 'Stay', Kind: 'Travel', Trip: 'Varanasi Sep 2026', Payment: 'Other', Account: 'UPI', Status: 'Logged', Reimbursable: false },
    { Name: 'Mangi Ferra @ Surya Kaiser Palace', Amount: 2496, date: '2026-09-06', Category: 'Food', Kind: 'Travel', Trip: 'Varanasi Sep 2026', Payment: 'Other', Account: 'Primary debit', Status: 'Logged', Reimbursable: false },
    ...
    { Name: 'ACKO travel insurance', Amount: 692, date: '2026-08-29', Category: 'Travel', Kind: 'Travel', Trip: 'Vietnam Sep 2026', Payment: 'Other', Account: 'Primary debit', Status: 'Logged', Reimbursable: false },
    { Name: 'Vietnam e-visa', Amount: 2441, date: '2026-08-22', Category: 'Travel', Kind: 'Travel', Trip: 'Vietnam Sep 2026', Payment: 'Card', Account: 'Primary debit', Status: 'Needs receipt', Reimbursable: false },
    { Name: 'Vietnam Airlines DEL–HAN–DAD RT', Amount: null, date: '2026-08-12', Category: 'Travel', Kind: 'Travel', Trip: 'Vietnam Sep 2026', Payment: 'Card', Account: 'Primary debit', Status: 'Needs receipt', Reimbursable: false },
    { Name: 'Mad Monkey Hoi An (Hostelworld deposit)', Amount: 561, date: '2026-08-01', Category: 'Stay', Kind: 'Travel', Trip: 'Vietnam Sep 2026', Payment: 'Card', Account: 'Primary debit', Status: 'Needs receipt', Reimbursable: false },
    { Name: 'Experience Co / BHX package', Amount: 85273.14, date: '2026-07-20', Category: 'Travel', Kind: 'Travel', Trip: 'Vietnam Sep 2026', Payment: 'Other', Account: 'Primary credit', Status: 'Needs receipt', Reimbursable: false },
  ].map(fromOwnerFixture);

  var SAMPLE_NOTION_ACCOUNTS = [
    { id: 'sample-acct-cash', url: '', name: 'Cash', notes: 'Example data. Opening balance pending from Raaghav', openingBalance: 0 },
    { id: 'sample-acct-upi', url: '', name: 'UPI', notes: 'Example data. Opening balance pending from Raaghav', openingBalance: 0 },
    { id: 'sample-acct-debit', url: '', name: 'Primary debit', notes: 'Example data. Opening balance pending from Raaghav', openingBalance: 0 },
    { id: 'sample-acct-credit', url: '', name: 'Primary credit', notes: 'Example data. Opening balance pending — use negative for amount owed', openingBalance: 0 },
    { id: 'sample-acct-corp', url: '', name: 'Corporate', notes: 'Example data. Opening balance pending from Raaghav', openingBalance: null },
  ];
