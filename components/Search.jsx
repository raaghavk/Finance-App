    ...
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column', background: typeof ZENITH !== 'undefined' ? ZENITH.page : '#F2F2F7' }}>
      <div style={{ padding: 'var(--zenith-pad-top) 20px 12px' }}>
        ...
        <div style={{
          ...
          border: `1.5px solid ${focused ? (typeof ZENITH !== 'undefined' ? ZENITH.accent : '#2563EB') : 'transparent'}`,
          boxShadow: '0 1px 4px rgba(0,0,0,0.06)',
        }}>
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" aria-hidden="true">
            <circle cx="6.5" cy="6.5" r="5" stroke={focused ? (typeof ZENITH !== 'undefined' ? ZENITH.accent : '#2563EB') : '#8E8E93'} strokeWidth="1.6"/>
            <path d="M10 10l4 4" stroke={focused ? (typeof ZENITH !== 'undefined' ? ZENITH.accent : '#2563EB') : '#8E8E93'} strokeWidth="1.6" strokeLinecap="round"/>
          </svg>
          <input
            type="search"
        ...
        <div style={{ display: 'flex', gap: 8, overflowX: 'auto', marginTop: 12 }}>
          <button
            ...
            style={{
              ...
              background: activeCat === 'All' ? (typeof ZENITH !== 'undefined' ? ZENITH.accent : '#2563EB') : '#FFFFFF',
          ...
          {[['date', locale === 'hi' ? 'नया' : 'Newest'], ['amount_desc', locale === 'hi' ? 'ज़्यादा' : 'Highest'], ['amount_asc', locale === 'hi' ? 'कम' : 'Lowest']].map(([id, label]) => (
            <button
              ...
              style={{
                ...
                color: sort === id ? (typeof ZENITH !== 'undefined' ? ZENITH.accent : '#2563EB') : '#8E8E93',
